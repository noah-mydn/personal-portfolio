    ...
    >
      <Box width="100%" id="portfolio" minHeight="100vh" mt={3} mb={2} pt={8}>
        <Box display="block" width="100%" height="100%">
          ...
          <Box display="flex" alignItems="center" px={1} flexWrap="wrap">
              ...
              <ProjectCard elevation={4}>
                <CardContent>
                  ...
                  >
                    ...
                    {project.framework[1] && (
                      <LanguageBox>{project.framework[1]}</LanguageBox>
                    )}
                    {project.framework[2] && (
                      <LanguageBox>{project.framework[2]}</LanguageBox>
                    )}
                ...
                <CardActionArea>
                  ...
                  >
                    ...
                    <StyledButton href={project.repoLink}>
                      View Repo
                    </StyledButton>
                  </Box>
                </CardActionArea>
